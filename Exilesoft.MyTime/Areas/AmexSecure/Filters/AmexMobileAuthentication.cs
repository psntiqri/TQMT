...
namespace Exilesoft.MyTime.Areas.AmexSecure.Filters
{
    public class AmexMobileAuthentication : AuthorizeAttribute
    {
        ...
        public AmexMobileAuthentication(params string[] roles)
		{
			_roleArray = roles;
		}
		...
		public override void OnAuthorization(AuthorizationContext filterContext)
		{
		    ...
		    {
                filterContext.Result = new RedirectResult("Mobile/Index");
		    }
		    else
		    {
