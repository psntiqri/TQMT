...
namespace Exilesoft.MyTime.Areas.Amex.Common
{
    public class AmexHelper
    {
        ...
        private static string GetCoockieName(DeviceType type)
        {
            ...
            else
            {
                coockieName =
                    System.Web.Configuration.WebConfigurationManager.OpenWebConfiguration(
                        "/Areas/AmexSecure/Web.config")
                        .AppSettings.Settings["AmexMobileCoockieName"].Value;
            }
            return coockieName;
        }
        ...
        private static string GetCallbackUrl(DeviceType type)
        {
            ...
            if (type == DeviceType.Desktop)
                callbackUrl =
                    System.Web.Configuration.WebConfigurationManager.OpenWebConfiguration("/Areas/AmexSecure/Web.config")
                        .AppSettings.Settings["AmexCallBackUrl"].Value;
            else
            {
                callbackUrl =
                    System.Web.Configuration.WebConfigurationManager.OpenWebConfiguration("/Areas/AmexSecure/Web.config")
                        .AppSettings.Settings["AmexMobileCallBackUrl"].Value;
            }
            return callbackUrl;
        }
